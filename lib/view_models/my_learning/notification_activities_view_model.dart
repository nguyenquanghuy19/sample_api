...
class NotificationActivitiesViewModel extends BaseViewModel {
  ...
  Future<void> getNotificationData({
    ...
    try {
      ...
      String param =
          "?Page=$_page&PerPage=10&Title=${searchController.text}&Type=$type";
      final res =
          await _notificationRepository.getNotificationActivities(param: param);
  ...
  void onChange(int index, {bool isCloseSearch = false}) {
    if (isCloseSearch) {
