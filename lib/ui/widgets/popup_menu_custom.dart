...
/// Used to configure how the [PopupMenuButtonCustom] positions its popup menu.
enum PopupMenuPositionCustom {
...
/// shows a popup menu, consider using [PopupMenuButtonCustom].
///
/// The type `T` is the type of the value(s) the entry represents. All the
/// entries in a given menu must represent values with consistent types.
///
/// A [PopupMenuEntryCustom] may represent multiple values, for example a row with
/// several icons, or a single entry, for example a menu item with an icon (see
/// [PopupMenuItemCustom]), or no value at all (for example, [PopupMenuDividerCustom]).
///
/// See also:
///
///  * [PopupMenuItemCustom], a popup menu entry for a single value.
///  * [PopupMenuDividerCustom], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonCustom], an [IconButton] that automatically shows a menu when
///    it is tapped.
abstract class PopupMenuEntryCustom<T> extends StatefulWidget {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const PopupMenuEntryCustom({super.key});
  ...
  ///
  /// If the [PopupMenuEntryCustom] represents a single value, this should return true
...
/// See also:
///
///  * [PopupMenuItemCustom], for the kinds of items that this widget divides.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonCustom], an [IconButton] that automatically shows a menu when
///    it is tapped.
class PopupMenuDividerCustom extends PopupMenuEntryCustom<Never> {
  /// Creates a horizontal divider for a popup menu.
  ///
  /// By default, the divider has a height of 16 logical pixels.
  const PopupMenuDividerCustom({super.key, this.height = _kMenuDividerHeight});
  ...
  @override
  State<PopupMenuDividerCustom> createState() => _PopupMenuDividerState();
}

class _PopupMenuDividerState extends State<PopupMenuDividerCustom> {
  @override
...
///
/// Typically the [child] of a [PopupMenuItemCustom] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [PopupMenuItemCustom] is [kMinInteractiveDimension] pixels high. If you use a widget
...
/// {@end-tool}
///
/// See the example at [PopupMenuButtonCustom] for how this example could be used in a
/// complete menu, and see the example at [CheckedPopupMenuItem] for one way to
/// keep the text of [PopupMenuItemCustom]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedPopupMenuItem]s or of [PopupMenuItemCustom]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDividerCustom], which can be used to divide items from each other.
///  * [CheckedPopupMenuItem], a variant of [PopupMenuItemCustom] with a checkmark.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonCustom], an [IconButton] that automatically shows a menu when
///    it is tapped.
class PopupMenuItemCustom<T> extends PopupMenuEntryCustom<T> {
  /// Creates an item for a popup menu.
  ///
  /// By default, the item is [enabled].
  ///
  /// The `enabled` and `height` arguments must not be null.
  const PopupMenuItemCustom({
    super.key,
    this.value,
    this.onTap,
    this.enabled = true,
  ...
  @override
  PopupMenuItemState<T, PopupMenuItemCustom<T>> createState() =>
      PopupMenuItemState<T, PopupMenuItemCustom<T>>();
}

/// The [State] for [PopupMenuItemCustom] subclasses.
///
/// By default this implements the basic styling and layout of Material Design
/// popup menu items.
///
/// The [buildChild] method can be overridden to adjust exactly what gets placed
/// in the menu. By default it returns [PopupMenuItemCustom.child].
///
/// The [handleTap] method can be overridden to adjust exactly what happens when
/// the item is tapped. By default, it uses [Navigator.pop] to return the
/// [PopupMenuItemCustom.value] from the menu route.
///
/// This class takes two type arguments. The second, `W`, is the exact type of
/// the [Widget] that is using this [State]. It must be a subclass of
/// [PopupMenuItemCustom]. The first, `T`, must match the type argument of that widget
/// class, and is the type of values returned from this menu.
class PopupMenuItemState<T, W extends PopupMenuItemCustom<T>> extends State<W> {
  /// The menu item contents.
  ///
  /// Used by the [build] method.
  ///
  /// By default, this returns [PopupMenuItemCustom.child]. Override this to put
  ...
  ///
  /// By default, uses [Navigator.pop] to return the [PopupMenuItemCustom.value] from
  /// the menu route.
  @protected
  void handleTap() {
    widget.onTap?.call();
...
/// matches the default minimum height of a [PopupMenuItemCustom]. The horizontal
...
/// See also:
///
///  * [PopupMenuItemCustom], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [PopupMenuDividerCustom], a popup menu entry that is just a horizontal line.
///  * [showMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButtonCustom], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItem<T> extends PopupMenuItemCustom<T> {
...
class _PopupMenuRoute<T> extends PopupRoute<T> {
  ...
  final RelativeRect position;
  final List<PopupMenuEntryCustom<T>> items;
...
/// [PopupMenuEntryCustom.represents] method returns true for `initialValue`, and then
/// summing the values of [PopupMenuEntryCustom.height] for all the preceding widgets
/// in the list.
///
...
///  * [PopupMenuDividerCustom], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [PopupMenuButtonCustom], which provides an [IconButton] that shows a menu by
...
Future<T?> showMenu<T>({
  ...
  required List<PopupMenuEntryCustom<T>> items,
  T? initialValue,
  double? elevation,
...
/// argument is the value of the [PopupMenuItemCustom] that caused its menu to be
/// dismissed.
///
...
typedef PopupMenuItemBuilder<T> = List<PopupMenuEntryCustom<T>> Function(
  BuildContext context,
);
...
class PopupMenuButtonCustom<T> extends StatefulWidget {
  ...
  const PopupMenuButtonCustom({
    ...
    this.enableFeedback,
    this.constraints,
    this.position = PopupMenuPositionCustom.over,
  }) : assert(
  ...
  ///
  /// When not set, the position defaults to [PopupMenuPositionCustom.over] which makes the
  /// popup menu appear directly over the button that was used to create it.
  final PopupMenuPositionCustom position;
...
class PopupMenuButtonCustomState<T> extends State<PopupMenuButtonCustom<T>> {
  ...
  void showButtonMenu() {
    ...
    switch (widget.position) {
      case PopupMenuPositionCustom.over:
        offset = widget.offset;
        break;
      case PopupMenuPositionCustom.under:
        offset =
    ...
    final List<PopupMenuEntryCustom<T>> items = widget.itemBuilder(context);
