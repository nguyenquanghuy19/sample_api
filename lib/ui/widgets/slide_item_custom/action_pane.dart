...
class ActionPaneData {
  ...
  /// The axis in which the SlideCustomView can slide.
...
class ActionPane extends StatefulWidget {
  ...
  /// A widget which animates when the [SlideCustomView] moves.
  final Widget motion;

  /// A widget which controls how the [SlideCustomView] dismisses.
  final Widget? dismissible;

  /// Indicates whether the [SlideCustomView] can be dismissed by dragging.
  ///
  /// Defaults to true.
  ...
  @override
  ActionPaneState createState() => ActionPaneState();
...
class ActionPaneState extends State<ActionPane> implements RatioConfigurator {
  ...
  void handleEndGestureChanged() {
    ...
    // Otherwise we close the the SlideCustomView.
    controller!.close();
  }
