...
class SlideGestureDetector extends StatefulWidget {
  const SlideGestureDetector({
    Key? key,
    this.enabled = true,
  ...
  @override
  SlideGestureDetectorState createState() => SlideGestureDetectorState();
}

class SlideGestureDetectorState extends State<SlideGestureDetector> {
  double dragExtent = 0;
